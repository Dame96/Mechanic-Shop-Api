...
def create_customer():
    ...
    new_customer = Customer(**customer_data) #unpacks dictionary directly into our customer model
...
#=====GET All Customers
# when this request is received a function to retrive and return all Customers will fire. 
